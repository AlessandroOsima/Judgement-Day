...
/*SF_DATA;ver:0.34;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:True,lprd:True,enco:False,frtr:True,vitr:True,dbil:True,rmgx:True,rpth:0,hqsc:True,hqlp:False,blpr:0,bsrc:0,bdst:0,culm:0,dpts:2,wrdp:True,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.4411765,fgcg:0.8203629,fgcb:1,fgca:0.01960784,fgde:0.02,fgrn:150,fgrf:250,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:1,x:32719,y:32712|diff-23-OUT;n:type:ShaderForge.SFN_VertexColor,id:2,x:33555,y:32614;n:type:ShaderForge.SFN_Tex2d,id:4,x:33547,y:32241,ptlb:Texture 1,ptin:_Texture1,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:7,x:33549,y:32436,ptlb:Texture 2,ptin:_Texture2,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:9,x:33549,y:32794,ptlb:Texture 3,ptin:_Texture3,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Lerp,id:10,x:33279,y:32382|A-4-RGB,B-7-RGB,T-2-R;n:type:ShaderForge.SFN_Lerp,id:23,x:33035,y:32711|A-10-OUT,B-9-RGB,T-2-B;proporder:4-7-9;pass:END;sub:END;*/

Shader "Shader Forge/TerrainMesh" {
    Properties {
...
/////// Diffuse:
                ...
                finalColor += diffuseLight * lerp(lerp(tex2D(_Texture1,TRANSFORM_TEX(node_96.rg, _Texture1)).rgb,tex2D(_Texture2,TRANSFORM_TEX(node_96.rg, _Texture2)).rgb,node_2.r),tex2D(_Texture3,TRANSFORM_TEX(node_96.rg, _Texture3)).rgb,node_2.b);
/// Final Color:
...
/////// Diffuse:
                ...
                float4 node_2 = i.vertexColor;
                finalColor += diffuseLight * lerp(lerp(tex2D(_Texture1,TRANSFORM_TEX(node_97.rg, _Texture1)).rgb,tex2D(_Texture2,TRANSFORM_TEX(node_97.rg, _Texture2)).rgb,node_2.r),tex2D(_Texture3,TRANSFORM_TEX(node_97.rg, _Texture3)).rgb,node_2.b);
/// Final Color:
