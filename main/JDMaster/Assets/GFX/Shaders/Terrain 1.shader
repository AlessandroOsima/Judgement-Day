...
/////// Diffuse:
                ...
                finalColor += diffuseLight * lerp(lerp(tex2D(_Texture1,TRANSFORM_TEX(node_30.rg, _Texture1)).rgb,tex2D(_Texture2,TRANSFORM_TEX(node_30.rg, _Texture2)).rgb,node_2.r),tex2D(_Texture3,TRANSFORM_TEX(node_30.rg, _Texture3)).rgb,node_2.b);
/// Final Color:
...
/////// Diffuse:
                ...
                float4 node_2 = i.vertexColor;
                finalColor += diffuseLight * lerp(lerp(tex2D(_Texture1,TRANSFORM_TEX(node_31.rg, _Texture1)).rgb,tex2D(_Texture2,TRANSFORM_TEX(node_31.rg, _Texture2)).rgb,node_2.r),tex2D(_Texture3,TRANSFORM_TEX(node_31.rg, _Texture3)).rgb,node_2.b);
/// Final Color:
