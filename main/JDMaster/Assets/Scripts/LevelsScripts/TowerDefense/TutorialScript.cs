...
public class TutorialScript : MonoBehaviour
{
    ...
    void WriteMessage(string s, float h, float w, float d)
    {
        ...
        while ((j = s.IndexOf(" ", i)) != -1)
        {
            ...
            LevelGUI.levelGUI.writeMessage(word, new Vector3(space, (h * height), 0f), new Vector3(1.2f, 1.2f, 1), d, 1);
    ...
    void Update()
    {
        ...
        {
            WriteMessage("Why not try a little FIRE!!", 0.75f, 0.25f, 5f);
        ...
        {
            WriteMessage("HAHAHAHAHAHAHAHAHA...", 0.75f, 0.25f, 4f);
            messageCount++;
        }
        ...
        if (!LevelGUI.levelGUI.isDisplayingMessages() && messageCount == 10)
        {
            ...
            WriteMessage("Your number of SOULS is up there with the crosses", 0.85f, 0.25f, 8f);
            messageCount++;
        }
